...
module Inferno
  module Sequence
    class UsCoreR4DiagnosticreportNoteSequence < SequenceBase
      ...
      title 'US Core R4 DiagnosticreportNote Tests'
      ...
      test 'Demonstrates that the server can supply must supported elements' do
        metadata {
          ...
          versions :r4
            ...
            skip 'Could not find DiagnosticReport.encounter in the provided resource' unless (@instance.must_support_confirmed.include? "DiagnosticReport.encounter") || can_resolve_path(@diagnosticreport, 'encounter')
